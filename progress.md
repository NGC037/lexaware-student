...
- Limitations: full Rights Explorer/article detail, Help Directory, assistant, document, and complaint screens remain future slices. A backend-specific emergency contact taxonomy/route was not found; the dashboard displays only governed verified contacts and does not invent emergency numbers. Activity, saved items, and announcements remain unavailable because no corresponding backend endpoints exist.
