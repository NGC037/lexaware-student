  ...
  return <div className="workspace-page">
    ...
    <section aria-labelledby="quick-actions-title" className="workspace-actions page-container">
      ...
      <div className="workspace-action-list">
        <a className="workspace-action workspace-action--primary" href="#guidance-query" onClick={(event) => { event.preventDefault(); document.getElementById("guidance-query")?.focus(); window.scrollTo({ top: 0, behavior: "smooth" }); }}><span className="workspace-action__icon"><BookOpen size={22} aria-hidden="true" /></span><span><strong>Know your rights</strong><small>Search reviewed, source-backed student guidance.</small></span><ArrowRight className="workspace-action__arrow" size={19} aria-hidden="true" /></a>
        <div className="workspace-action workspace-action--soon"><span className="workspace-action__icon"><Sparkles size={22} aria-hidden="true" /></span><span><strong>Ask the assistant</strong><small>Grounded, source-cited conversations are coming soon.</small></span><span className="workspace-coming">Coming soon</span></div>
        <div className="workspace-action workspace-action--soon"><span className="workspace-action__icon"><FileText size={22} aria-hidden="true" /></span><span><strong>Review a document</strong><small>Your private document workspace is coming soon.</small></span><span className="workspace-coming">Coming soon</span></div>
        ...
        <div className="workspace-action workspace-action--soon"><span className="workspace-action__icon"><LifeBuoy size={22} aria-hidden="true" /></span><span><strong>Complaint guidance</strong><small>Structured complaint guidance is coming soon.</small></span><span className="workspace-coming">Coming soon</span></div>
      </div>
    </section>
    ...
    <div className="workspace-lower page-container">
      ...
      <section aria-labelledby="dashboard-support-title" className="workspace-support" id="dashboard-support">
        <p className="eyebrow"><LifeBuoy size={15} aria-hidden="true" /> REVIEWED SUPPORT</p><h2 id="dashboard-support-title">Need help finding a next step?</h2><p className="workspace-support__intro">These contacts come from the currently verified support directory.</p>
